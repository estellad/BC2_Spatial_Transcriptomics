...
spe <- as(vis_aggxe_sce, "SpatialExperiment")
spe@int_colData@listData$spatialCoords <- as.matrix(colData(vis_aggxe_sce)[, coord_names])
ggspavis::plotDimRed(spe, type = "UMAP", annotate = "nCount_Spatial")
